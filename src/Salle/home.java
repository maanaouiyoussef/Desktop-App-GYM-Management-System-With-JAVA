...
public class home extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setForeground(new java.awt.Color(232, 252, 255));
        jLabel2.setText("Manager Votre Payement Bancaire De La Salle ");
        ...
        jMenu2.setText("Editer & Supprimer Membre");
        ...
        jMenu3.setText("Tous Les Membres");
        ...
        jMenu4.setText("Paiement Bancaire");
        ...
        jMenu5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/billing.png"))); // NOI18N
        jMenu5.setText("Facturation");
    ...
    private void jMenu7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jMenu7MouseClicked
        ...
        int a=JOptionPane.showConfirmDialog(null,"Vous etes sure de quitter l'application ?","Quitter l'application",JOptionPane.YES_NO_OPTION);
        if(a == 0) {
          System.exit(0);
        }
    ...
    private void jMenu6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jMenu6MouseClicked
        // TODO add your handling code here:
        int a=JOptionPane.showConfirmDialog(null, "Vous etes sure de se deconnecter ?","Deconnexion Message",JOptionPane.YES_NO_OPTION);
        if(a==0) {
